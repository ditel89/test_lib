...
import 'package:container_lib/dbdetailpage.dart';

class DBHomePageBody extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    //return new drugdataRow(drugdatas[0]);
    return new Expanded(
      child: new ListView.builder(
          itemBuilder: (context, index) => new DrugRow(),
          itemCount: 1,
...
class DrugRow extends StatelessWidget {
  ...
  DrugRow({this.horizontal = true});

  DrugRow.vertical() : horizontal = false;
  ...
  Widget build(BuildContext context) {
    final drugdataThumbnail = new Container(
      ...
      child: new Hero(
        tag: "dbdata-hero-${0}",
        child: new Image(
          image: new AssetImage("img/db.png"),
          height: 92.0,
          width: 92.0,
        ),
      ),
        ...
        onTap: horizontal
            ? () => Navigator.of(context).push(
                  new PageRouteBuilder(
                    pageBuilder: (_, __, ___) => new DBDetailPage(),
